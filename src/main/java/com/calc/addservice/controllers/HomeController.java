...
public class HomeController {
    ...
    public ResponseEntity<GenericResponseObject> index() {
        ...
        return new ResponseEntity<>(new GenericResponseObject(){ { setSuccess(true); setMessage("Hello!! This is add service. My other endpoints are: [GET]/healthcheck and [POST]/sum. Use Wisely. Latest Test"); } }, 
            HttpStatus.OK);     
    }
